...
def bumpChecker(playerNum, PlayerList):
    ...
    for idx, player in enumerate(PlayerList):
        ...
        if player != curr_player: ##self-bumping is taken care of in the generation of new positions
            ...
            if 0<curr_player.position[0]<101 and curr_player.position[0] in player.position:
            ...
            if 0<curr_player.position[1]<101 and curr_player.position[1] in player.position:
